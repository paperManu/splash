    ...
    : _scope(scope)
{
    ...
    if (previousError != GL_NO_ERROR)
    {
        ...
        case GL_INVALID_ENUM:
            Log::get() << Log::WARNING << _scope << " - Previous OpenGL ES error: GL_INVALID_ENUM" << Log::endl;
            return;
        case GL_INVALID_VALUE:
            Log::get() << Log::WARNING << _scope << " - Previous OpenGL ES error: GL_INVALID_VALUE" << Log::endl;
            return;
        case GL_INVALID_OPERATION:
            Log::get() << Log::WARNING << _scope << " - Previous OpenGL ES error: GL_INVALID_OPERATION" << Log::endl;
            return;
        case GL_INVALID_FRAMEBUFFER_OPERATION:
            Log::get() << Log::WARNING << _scope << " - Previous OpenGL ES error: GL_INVALID_FRAMEBUFFER_OPERATION" << Log::endl;
            return;
        case GL_OUT_OF_MEMORY:
            Log::get() << Log::WARNING << _scope << " - Previous OpenGL ES error: GL_OUT_OF_MEMORY" << Log::endl;
            return;
        case GL_STACK_UNDERFLOW:
            Log::get() << Log::WARNING << _scope << " - Previous OpenGL ES error: GL_STACK_UNDERFLOW" << Log::endl;
            return;
        case GL_STACK_OVERFLOW:
            Log::get() << Log::WARNING << _scope << " - Previous OpenGL ES error: GL_STACK_OVERFLOW" << Log::endl;
            return;
        }
    }
}
